...
namespace BigDataOrdersDashboard.Controllers
{
    public class StatisticsController : Controller
    {
        ...
        public StatisticsController(BigDataDbContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.CustomerCount = _context.Customers
                .Select(x => x.CustomerCountry)
                .Distinct()
                .Count();

            ViewBag.CustomerCity = _context.Customers
                .Select(x => x.CustomerCity)
                .Distinct()
                .Count();

            ViewBag.OrderStatusByCompleted = _context.Orders
                .Where(x => x.OrderStatus == "Tamamlandı")
                .Count();

            ViewBag.OrderStatusByCancelled = _context.Orders
                .Where(x => x.OrderStatus == "İptal Edildi")
                .Count();
